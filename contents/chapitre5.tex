...
\fbox{\begin{minipage}{0.9\textwidth}
   ...
   \begin{itemize}
   \item lorsque la différence de chemin $(r_2-r_1)$ vaut un multiple impair de $\lambda/2$, 
   $$(r_2-r_1) = (n + 1/2)\lambda,$$ les ondes interfèrent de manière destructive.
             Les maxima de l'une se superposent aux minima de l'autre. 
   \item lorsque la différence de chemin $(r_2-r_1)$ vaut un multiple pair de $\lambda/2$
   $$(r_2-r_1) = n\lambda,$$ les ondes interfèrent de manière constructive.
