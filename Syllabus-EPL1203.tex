...
\begin{document}
	...
	\begin{fullwidth}
        ...
        \end{center}
		Toute amélioration est la bienvenue, sur GitHub ou sur le forum Moodle du cours.
    \end{fullwidth}
	\vfill
	\begin{figure*}
		\centering
	...
	\tableofcontents
	\input{contents/chapitre1.tex}
	\input{contents/chapitre2.tex}
	\input{contents/chapitre3.tex}
	\input{contents/chapitre4.tex}
	\input{contents/chapitre5.tex}
	\input{contents/chapitre6.tex}
	\input{contents/chapitre7.tex}
	\input{contents/chapitre8.tex}
	\input{contents/annexe.tex}
\end{document}
